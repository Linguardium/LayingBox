...
public class LayingBoxMain implements ModInitializer {
    ...
    public static ItemGroup ITEM_GROUP_PELLETS = FabricItemGroupBuilder.create(new Identifier(MOD_ID,"pellets_group")).icon(()-> new ItemStack(ModItems.DEFAULT_PELLET)).build();
