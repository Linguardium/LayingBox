...
public class ModBlocks {
    ...
    public static void init() {
        ...
        EGG_COLLECTOR = Registry.register(Registry.BLOCK,new Identifier(MOD_ID,"egg_collector"),new EggCollector(FabricBlockSettings.copyOf(Blocks.OAK_PLANKS).suffocates(never).allowsSpawning(typed_never).solidBlock(always)) );
